        ...
        <div class="flex-shrink-0 flex items-center">
          <a href="{{home_url()}}">
            ...
            <img class="lg:hidden block h-12 w-auto"
                 src="@php esc_attr_e(get_field('logo_mobile', 'option')['url']);  @endphp"
                 alt="Attractive Neon Logo V2">
          </a>
        </div>
      </div>
    ...
    <!-- Mobile menu button -->
      ...
      <div class="hidden lg:relative lg:z-10 lg:ml-4 lg:flex lg:items-center">
        <a href="{{wc_get_cart_url()}}"
           class="flex-shrink-0 bg-white mr-4 rounded-full p-1 text-gray-900 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary">
        ...
        <a href="{{get_permalink( get_option('woocommerce_myaccount_page_id') )}}"
           class="flex-shrink-0 bg-white rounded-full p-1 text-gray-900 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary">
  ...
  <nav x-cloak
    ...
    <div class="pt-2 pb-3 px-2">
      ...
      <div class="relative flex lg:hidden items-center justify-around py-4 px-3 mt-6">
        ...
        <a href="{{wc_get_cart_url()}}"
           class="flex w-1/2 items-center justify-center gap-2 flex-shrink-0 bg-gray-200 rounded p-4 text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary">
